 ...
 * @author bdickie
 */
public enum FileInfoPreferences {
    DVDPath(false, "/dev/dvd");
    
    private FileInfoPreferences(boolean global, String defaultValue) {
        if (global)
    ...
    private FileInfoPreferences(boolean global, int defaultValue) {
        if (global)
            pref = new PreferenceObject(getClass(), name(), defaultValue);
        else
            pref = new LocalPreferenceObject(getClass(), name(), defaultValue);
    ...
    private FileInfoPreferences(boolean global, boolean defaultValue) {
        if (global)
            pref = new PreferenceObject(getClass(), name(), defaultValue);
        else
            pref = new LocalPreferenceObject(getClass(), name(), defaultValue);
    ...
    private FileInfoPreferences(boolean global, long defaultValue) {
        if (global)
            pref = new PreferenceObject(getClass(), name(), defaultValue);
        else
            pref = new LocalPreferenceObject(getClass(), name(), defaultValue);
