 ...
 * @author bdickie
 */
public class GenreReloadPeriodicTask extends PeriodicTask {
    ...
    protected Long getRunPeriodPreferenceValue() {
        return TMDbPreference.GenresLastRefreshed.getLong();
    }

    @Override
    protected void setRunPeriodPreferenceValue(long lastRun) {
        TMDbPreference.GenresLastRefreshed.setLong(lastRun);
    }
