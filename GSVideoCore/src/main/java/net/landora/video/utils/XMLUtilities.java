...
private static final Logger log = LoggerFactory.getLogger(XMLUtilities.class);
    ...
    /** Converts a String into a DOM tree.
     * @param xml The File containing the XML content to parse into a DOM tree.
     * @param validating Weither the parser should do schema validation on the input.
     * @return The document root of the object if successful, null otherwise.
     */
    ...
    /** Converts a String into a DOM tree.
     * @param xml The source to parse into a DOM tree.
     * @param validating Weither the parser should do schema validation on the input.
     * @return The document root of the object if successful, null otherwise.
     */
    public static Document parseXML(InputSource xml, boolean validating) {
        try {
     ...
     * @return true iff no errors were reported in the parsing.
     */
    public static boolean saxParse(File xml, SAXHandler handler, boolean validating) {
        try {
     ...
     *  name attribute is the given value.
     * @param parent The Element to search in.
