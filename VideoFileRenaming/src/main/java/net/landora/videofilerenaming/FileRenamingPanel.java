...
final class FileRenamingPanel extends javax.swing.JPanel {

    private final FileRenamingOptionsPanelController controller;
    
    private RenameScriptManager mng = RenameScriptManager.getInstance();

    FileRenamingPanel(FileRenamingOptionsPanelController controller) {
        ...
        txtFolderScript.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                FileRenamingPanel.this.controller.changed();
            }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(FileRenamingPanel.class, "FileRenamingPanel.jLabel3.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(FileRenamingPanel.class, "FileRenamingPanel.jLabel4.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(FileRenamingPanel.class, "FileRenamingPanel.jLabel5.text")); // NOI18N

        txtFolderResult.setEditable(false);

        txtFileResult.setEditable(false);
        txtFileResult.setText(org.openide.util.NbBundle.getMessage(FileRenamingPanel.class, "FileRenamingPanel.txtFileResult.text")); // NOI18N
